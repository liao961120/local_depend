...
選擇 `quanteda`而非其它較流行的套件如`tm`的原因是因為其[多語言支持](https://github.com/quanteda/stopwords)較佳，譬如其內建的 tokenizer 能直接對中文進行斷詞。然而，由於 [`jieba`](https://github.com/fxsjy/jieba)的社群資源以及斷詞效果較佳，此文還是以[`jiebaR`](https://github.com/qinwf/jiebaR)進行斷詞。
