...
str_date <- "`r format(Sys.Date(), '%B %d, %Y')`"
```
...
- Prefix & Suffix
    - `Text [see @Bib.ID1 pp.45; also, @Bib.ID2 ch. 2].`
...
<iframe src="https://www.slideshare.net/slideshow/embed_code/key/1xBpPrD61JbE0w" width=90%" height="440" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:0px solid #FFFFFF; border-width:0px; margin-bottom:0px; max-width: 100%;" allowfullscreen></iframe>

Note: In full screen mode (on PC), you can use arrow keys to navigate through the slides.


[Download Beamer Slide](https://github.com/liao961120/local_depend/blob/master/GitHubPage/my_R_book/Rmarkdown_features/beamer/beamer.pdf)
